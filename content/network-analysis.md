...
Out of all the characters, Harry Potter is mentioned the most in this book, which makes great sense, since he is the main character of the book series. 
Hagrid interacts with Harry in most chapters in this book, which heightens Hagrid's mention count. 
...
It seems natural that both Ron and Hermiones nodes are large, since they are Harry's best friends. Ron's node is slightly bigger than Hermiones, which is probably because Harry befriended Ron earlier in the book than he did Hermione. 
...
Even though Quirrell is the main antagonist in this book, his node is fairly small. This is probably, because Harry thinks Snape is the bad guy for a great part of the books.
...
Harry, Ron and Hermione are all mentioned  lot, which makes great sense, since Harry is the main character and his best friends are Hermione and Ron. 
...
Once again, the trio is mentioned a lot in this book. Sirius Black is the Prisoner of Azkaban referenced in the book title, which makes it natural for him to be mentioned a lot during this book. 
...
<h3>
Based on previous observations, it is fair to assume that The Trio, along with characters like Hagrid, Snape, Dumbledore, Draco, and MacGonagall, are all mentioned fairly often in all the books. 
...
While Alastor Moody is mentioned by name multiple times during this book, the character himself does not play such a big part in this book. 
Since the Moody mentioned throughout the book technically refer to Barty Crouch Jr. Barty Crouch Jr is thought to be Alastor Moody for the majority of the book, if the network creation was more intelligent, it should be possible to add 
certain conditions to change this behaviour. However, for now, it makes sense that Alastor Moody is a large node in this book, since helps Harry a lot before he is revealed as one of the antagonists as Barty Crouch.
Lord Voldemort is represented by a much larger node in this book, which is a sign, that he is slowly starting to get more important as a character. 
...
Meanwhile, Bagman is present at both the Quidditch World Cup, The Twirwizard Tournament, and in Hogsmead. Meaning that both characters are mentioned many times in the book.
...
Because so many characters are mentioned, the individual importance of the characters become less clear, since the node size varies less. 
...
From the looks of the network this book primarily focus on original characters, since it is the nodes of Draco, Voldemort, Dumbledore, and Snape, that have changed the most. 
This makes great sense, since the book contains a lot of information about Harry and Dumbledore's investigation of Voldemort's past. Furthermore, Snape and Draco are becoming more prominent characters, which aligns with the look of the network. 
...
<h3>
Once again, this book seems to focus on the main characters (Voldemort, the trio, and Dumbledore especially). 
...
only mentioning other characters whn they interact with the trio in some way. Voldemort is the main antagonist in this book and is the character the trio must defeat. 
It is interesting that Dumbledore still remain a large node, since he dies in the previous book. However, he is mentioned quite a lot, because Harry tries to figure out hints Dumbledore gave while alive. 
...
<h3>
The method used to create the weighted networks have the apperance of working fairly well. 
The most important characters of each book are easy to spot, and it is obvious why the large nodes are sized as they are presented. 
It is more difficult to make any conclusions about the importance of the characters with smaller notes, since the books introduces a multitude of different characters, making it difficult to distinguish between node size.
</h3>